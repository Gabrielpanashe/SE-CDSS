      ...
      <div className="hidden lg:flex lg:w-1/2 relative flex-col justify-end overflow-hidden">
        ...
        <div className="relative z-10 p-10 pb-12">
          ...
          <p className="text-sm text-slate-300 max-w-xs leading-relaxed">
            Create your account to access personalised medication analysis, risk assessment, and clinical recommendations.
          </p>
        </div>
      </div>
            ...
            {role === "patient" && (
              <div>
                ...
                <p className="text-xs text-slate-400 dark:text-slate-500 mt-1.5">
                  Format: P-XXXXX — links your account to an existing EHR profile
                </p>
              </div>
            )}
